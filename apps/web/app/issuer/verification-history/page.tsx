...
export default function Page() {
	...
	useEffect(() => { getAuditLogs().then((items) => setLogs(items.filter((item) => item.action === "VERIFY_CERTIFICATE"))).catch(() => setError("Unable to load verification history from the backend.")); }, []);
